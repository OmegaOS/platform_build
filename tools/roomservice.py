...
# Copyright (C) 2017, OmegaOS Project
#
...
custom_local_manifest = ".repo/local_manifests/omega_manifest.xml"
custom_default_revision = "n7.1"
custom_dependencies = "omega.dependencies"
org_manifest = "OmegaOS"  # leave empty if org is provided in manifest
org_display = "OmegaOS"  # needed for displaying
